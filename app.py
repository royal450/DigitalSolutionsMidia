...
# Rate Limiting Setup (Using Persistent Storage)
...
def is_rate_limited(ip, api_key):
    """ यूज़र की API लिमिट चेक करता है। """
